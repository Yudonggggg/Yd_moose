...
Real
GeneralSensorPostprocessor::getDrift()
{
  Real drift_value;
...
Real
GeneralSensorPostprocessor::getEfficiency()
{
  return _efficiency_function.value(_t);
}

Real
GeneralSensorPostprocessor::getSignalToNoiseFactor()
{
  return _signalToNoise_function.value(_t);
}

Real
GeneralSensorPostprocessor::getNoiseStdDev()
{
  return _noise_std_dev_function.value(_t);
}

Real
GeneralSensorPostprocessor::getNoise(Real noise_std_dev)
{
  return _rng.randNormal(0, noise_std_dev);
}

Real
GeneralSensorPostprocessor::getUncertaintyStdDev()
{
  return _uncertainty_std_dev_function.value(_t);
}

Real
GeneralSensorPostprocessor::getUncertainty(Real uncertainty_std_dev)
{
  return _rng.randNormal(0, uncertainty_std_dev);
}

Real
GeneralSensorPostprocessor::getDelay()
{
  return _delay_function.value(_t);
}

Real
GeneralSensorPostprocessor::getDelayedInputSignal(Real delay_value,
                                                  std::vector<Real> time_values,
                                                  std::vector<Real> input_signal_values)
{
  ...
  else if (t_desired > time_values[0] && t_desired < _t - _dt)
  {
    ...
    mooseError("Some error in interpolation values.");

  return input_signal_delayed;
}

Real
GeneralSensorPostprocessor::getIntegral(std::vector<Real> integrand, std::vector<Real> time_values)
{
